...

{
  ...
  "answer": "B",
  "explanation": "解析（如果原文中有就用原文；如果没有，基于答案和选项自己写至少 50 字 NPDP 角度的解析，**不要返回空字符串**）",
  "tags": ["NPDP"],
  "difficulty": 2
}
...
export const PROMPT_GEN_PROMPT = `你是一个产品经理认证（NPDP）出题专家。根据用户给的知识点 + 上下文（教材章节、考点关键词），出一道高质量选择题。
